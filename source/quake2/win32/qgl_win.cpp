...
{
	FS_Printf( glw_state.log_fp, "glColor4f( %f,%f,%f,%f )\n", red, green, blue, alpha );
	dllColor4f( red, green, blue, alpha );
}
static void APIENTRY logColor4fv(const GLfloat *v)
{
	FS_Printf( glw_state.log_fp, "glColor4fv( %f,%f,%f,%f )\n", v[0], v[1], v[2], v[3] );
	dllColor4fv( v );
}
...
{
	FS_Printf( glw_state.log_fp, "glDisable( 0x%x )\n", cap );
	dllDisable( cap );
}
...
{
	FS_Printf( glw_state.log_fp, "glEnable( 0x%x )\n", cap );
	dllEnable( cap );
}
...
{
	FS_Printf( glw_state.log_fp, "glHint( 0x%x, 0x%x )\n", target, mode );
	dllHint( target, mode );
}
...
{
	FS_Printf( glw_state.log_fp, "glPolygonMode( 0x%x, 0x%x )\n", face, mode );
...
{
	FS_Printf( glw_state.log_fp, "glTexEnvf( 0x%x, 0x%x, %f )\n", target, pname, param );
...
{
	FS_Printf( glw_state.log_fp, "glTexEnvi( 0x%x, 0x%x, 0x%x )\n", target, pname, param );
...
{
	FS_Printf( glw_state.log_fp, "glTexParameterf( 0x%x, 0x%x, %f )\n", target, pname, param );
...
{
	FS_Printf( glw_state.log_fp, "glTexParameteri( 0x%x, 0x%x, 0x%x )\n", target, pname, param );
...
qboolean QGL_Init( const char *dllname )
{
	...
	qglAccum                     = dllAccum = (void ( APIENTRY *)(GLenum op, GLfloat value))GPA( "glAccum" );
	qglAlphaFunc                 = dllAlphaFunc = (void ( APIENTRY *)(GLenum func, GLclampf ref))GPA( "glAlphaFunc" );
	qglAreTexturesResident       = dllAreTexturesResident = (GLboolean ( APIENTRY *)(GLsizei n, const GLuint *textures, GLboolean *residences))GPA( "glAreTexturesResident" );
	qglArrayElement              = dllArrayElement = (void ( APIENTRY *)(GLint i))GPA( "glArrayElement" );
	qglBegin                     = dllBegin = (void ( APIENTRY *)(GLenum mode))GPA( "glBegin" );
	qglBindTexture               = dllBindTexture = (void ( APIENTRY *)(GLenum target, GLuint texture))GPA( "glBindTexture" );
	qglBitmap                    = dllBitmap = (void ( APIENTRY *)(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap))GPA( "glBitmap" );
	qglBlendFunc                 = dllBlendFunc = (void ( APIENTRY *)(GLenum sfactor, GLenum dfactor))GPA( "glBlendFunc" );
	qglCallList                  = dllCallList = (void ( APIENTRY *)(GLuint list))GPA( "glCallList" );
	qglCallLists                 = dllCallLists = (void ( APIENTRY *)(GLsizei n, GLenum type, const GLvoid *lists))GPA( "glCallLists" );
	qglClear                     = dllClear = (void ( APIENTRY *)(GLbitfield mask))GPA( "glClear" );
	qglClearAccum                = dllClearAccum = (void ( APIENTRY *)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha))GPA( "glClearAccum" );
	qglClearColor                = dllClearColor = (void ( APIENTRY *)(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha))GPA( "glClearColor" );
	qglClearDepth                = dllClearDepth = (void ( APIENTRY *)(GLclampd depth))GPA( "glClearDepth" );
	qglClearIndex                = dllClearIndex = (void ( APIENTRY *)(GLfloat c))GPA( "glClearIndex" );
	qglClearStencil              = dllClearStencil = (void ( APIENTRY *)(GLint s))GPA( "glClearStencil" );
	qglClipPlane                 = dllClipPlane = (void ( APIENTRY *)(GLenum plane, const GLdouble *equation))GPA( "glClipPlane" );
	qglColor3b                   = dllColor3b = (void ( APIENTRY *)(GLbyte red, GLbyte green, GLbyte blue))GPA( "glColor3b" );
	qglColor3bv                  = dllColor3bv = (void ( APIENTRY *)(const GLbyte *v))GPA( "glColor3bv" );
	qglColor3d                   = dllColor3d = (void ( APIENTRY *)(GLdouble red, GLdouble green, GLdouble blue))GPA( "glColor3d" );
	qglColor3dv                  = dllColor3dv = (void ( APIENTRY * )(const GLdouble *v))GPA( "glColor3dv" );
	qglColor3f                   = dllColor3f = (void ( APIENTRY *)(GLfloat red, GLfloat green, GLfloat blue))GPA( "glColor3f" );
	qglColor3fv                  = dllColor3fv = (void ( APIENTRY *)(const GLfloat *v))GPA( "glColor3fv" );
	qglColor3i                   = dllColor3i = (void ( APIENTRY *)(GLint red, GLint green, GLint blue))GPA( "glColor3i" );
	qglColor3iv                  = dllColor3iv = (void ( APIENTRY *)(const GLint *v))GPA( "glColor3iv" );
	qglColor3s                   = dllColor3s = (void ( APIENTRY *)(GLshort red, GLshort green, GLshort blue))GPA( "glColor3s" );
	qglColor3sv                  = dllColor3sv = (void ( APIENTRY *)(const GLshort *v))GPA( "glColor3sv" );
	qglColor3ub                  = dllColor3ub = (void ( APIENTRY *)(GLubyte red, GLubyte green, GLubyte blue))GPA( "glColor3ub" );
	qglColor3ubv                 = dllColor3ubv = (void ( APIENTRY *)(const GLubyte *v))GPA( "glColor3ubv" );
	qglColor3ui                  = dllColor3ui = (void ( APIENTRY *)(GLuint red, GLuint green, GLuint blue))GPA( "glColor3ui" );
	qglColor3uiv                 = dllColor3uiv = (void ( APIENTRY *)(const GLuint *v))GPA( "glColor3uiv" );
	qglColor3us                  = dllColor3us = (void ( APIENTRY *)(GLushort red, GLushort green, GLushort blue))GPA( "glColor3us" );
	qglColor3usv                 = dllColor3usv = (void ( APIENTRY *)(const GLushort *v))GPA( "glColor3usv" );
	qglColor4b                   = dllColor4b = (void ( APIENTRY *)(GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha))GPA( "glColor4b" );
	qglColor4bv                  = dllColor4bv = (void ( APIENTRY *)(const GLbyte *v))GPA( "glColor4bv" );
	qglColor4d                   = dllColor4d = (void ( APIENTRY *)(GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha))GPA( "glColor4d" );
	qglColor4dv                  = dllColor4dv = (void ( APIENTRY *)(const GLdouble *v))GPA( "glColor4dv" );
	qglColor4f                   = dllColor4f = (void ( APIENTRY *)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha))GPA( "glColor4f" );
	qglColor4fv                  = dllColor4fv = (void ( APIENTRY *)(const GLfloat *v))GPA( "glColor4fv" );
	qglColor4i                   = dllColor4i = (void ( APIENTRY *)(GLint red, GLint green, GLint blue, GLint alpha))GPA( "glColor4i" );
	qglColor4iv                  = dllColor4iv = (void ( APIENTRY *)(const GLint *v))GPA( "glColor4iv" );
	qglColor4s                   = dllColor4s = (void ( APIENTRY *)(GLshort red, GLshort green, GLshort blue, GLshort alpha))GPA( "glColor4s" );
	qglColor4sv                  = dllColor4sv = (void ( APIENTRY *)(const GLshort *v))GPA( "glColor4sv" );
	qglColor4ub                  = dllColor4ub = (void ( APIENTRY *)(GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha))GPA( "glColor4ub" );
	qglColor4ubv                 = dllColor4ubv = (void ( APIENTRY *)(const GLubyte *v))GPA( "glColor4ubv" );
	qglColor4ui                  = dllColor4ui = (void ( APIENTRY *)(GLuint red, GLuint green, GLuint blue, GLuint alpha))GPA( "glColor4ui" );
	qglColor4uiv                 = dllColor4uiv = (void ( APIENTRY *)(const GLuint *v))GPA( "glColor4uiv" );
	qglColor4us                  = dllColor4us = (void ( APIENTRY *)(GLushort red, GLushort green, GLushort blue, GLushort alpha))GPA( "glColor4us" );
	qglColor4usv                 = dllColor4usv = (void ( APIENTRY *)(const GLushort *v))GPA( "glColor4usv" );
	qglColorMask                 = dllColorMask = (void ( APIENTRY *)(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha))GPA( "glColorMask" );
	qglColorMaterial             = dllColorMaterial = (void ( APIENTRY *)(GLenum face, GLenum mode))GPA( "glColorMaterial" );
	qglColorPointer              = dllColorPointer = (void ( APIENTRY *)(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer))GPA( "glColorPointer" );
	qglCopyPixels                = dllCopyPixels = (void ( APIENTRY *)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum type))GPA( "glCopyPixels" );
	qglCopyTexImage1D            = dllCopyTexImage1D = (void ( APIENTRY *)(GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLint border))GPA( "glCopyTexImage1D" );
	qglCopyTexImage2D            = dllCopyTexImage2D = (void ( APIENTRY *)(GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border))GPA( "glCopyTexImage2D" );
	qglCopyTexSubImage1D         = dllCopyTexSubImage1D = (void ( APIENTRY *)(GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width))GPA( "glCopyTexSubImage1D" );
	qglCopyTexSubImage2D         = dllCopyTexSubImage2D = (void ( APIENTRY *)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height))GPA( "glCopyTexSubImage2D" );
	qglCullFace                  = dllCullFace = (void ( APIENTRY *)(GLenum mode))GPA( "glCullFace" );
	qglDeleteLists               = dllDeleteLists = (void ( APIENTRY *)(GLuint list, GLsizei range))GPA( "glDeleteLists" );
	qglDeleteTextures            = dllDeleteTextures = (void ( APIENTRY *)(GLsizei n, const GLuint *textures))GPA( "glDeleteTextures" );
	qglDepthFunc                 = dllDepthFunc = (void ( APIENTRY *)(GLenum func))GPA( "glDepthFunc" );
	qglDepthMask                 = dllDepthMask = (void ( APIENTRY *)(GLboolean flag))GPA( "glDepthMask" );
	qglDepthRange                = dllDepthRange = (void ( APIENTRY *)(GLclampd zNear, GLclampd zFar))GPA( "glDepthRange" );
	qglDisable                   = dllDisable = (void ( APIENTRY *)(GLenum cap))GPA( "glDisable" );
	qglDisableClientState        = dllDisableClientState = (void ( APIENTRY *)(GLenum array))GPA( "glDisableClientState" );
	qglDrawArrays                = dllDrawArrays = (void ( APIENTRY *)(GLenum mode, GLint first, GLsizei count))GPA( "glDrawArrays" );
	qglDrawBuffer                = dllDrawBuffer = (void ( APIENTRY *)(GLenum mode))GPA( "glDrawBuffer" );
	qglDrawElements              = dllDrawElements = (void ( APIENTRY *)(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices))GPA( "glDrawElements" );
	qglDrawPixels                = dllDrawPixels = (void ( APIENTRY *)(GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glDrawPixels" );
	qglEdgeFlag                  = dllEdgeFlag = (void ( APIENTRY *)(GLboolean flag))GPA( "glEdgeFlag" );
	qglEdgeFlagPointer           = dllEdgeFlagPointer = (void ( APIENTRY *)(GLsizei stride, const GLvoid *pointer))GPA( "glEdgeFlagPointer" );
	qglEdgeFlagv                 = dllEdgeFlagv = (void ( APIENTRY *)(const GLboolean *flag))GPA( "glEdgeFlagv" );
	qglEnable                    = 	dllEnable                    = (void ( APIENTRY *)(GLenum cap))GPA( "glEnable" );
	qglEnableClientState         = 	dllEnableClientState         = (void ( APIENTRY *)(GLenum array))GPA( "glEnableClientState" );
	qglEnd                       = 	dllEnd                       = (void ( APIENTRY *)(void))GPA( "glEnd" );
	qglEndList                   = 	dllEndList                   = (void ( APIENTRY *)(void))GPA( "glEndList" );
	qglEvalCoord1d				 = 	dllEvalCoord1d				 = (void ( APIENTRY *)(GLdouble u))GPA( "glEvalCoord1d" );
	qglEvalCoord1dv              = 	dllEvalCoord1dv              = (void ( APIENTRY *)(const GLdouble *u))GPA( "glEvalCoord1dv" );
	qglEvalCoord1f               = 	dllEvalCoord1f               = (void ( APIENTRY *)(GLfloat u))GPA( "glEvalCoord1f" );
	qglEvalCoord1fv              = 	dllEvalCoord1fv              = (void ( APIENTRY *)(const GLfloat *u))GPA( "glEvalCoord1fv" );
	qglEvalCoord2d               = 	dllEvalCoord2d               = (void ( APIENTRY *)(GLdouble u, GLdouble v))GPA( "glEvalCoord2d" );
	qglEvalCoord2dv              = 	dllEvalCoord2dv              = (void ( APIENTRY *)(const GLdouble *u))GPA( "glEvalCoord2dv" );
	qglEvalCoord2f               = 	dllEvalCoord2f               = (void ( APIENTRY *)(GLfloat u, GLfloat v))GPA( "glEvalCoord2f" );
	qglEvalCoord2fv              = 	dllEvalCoord2fv              = (void ( APIENTRY *)(const GLfloat *u))GPA( "glEvalCoord2fv" );
	qglEvalMesh1                 = 	dllEvalMesh1                 = (void ( APIENTRY *)(GLenum mode, GLint i1, GLint i2))GPA( "glEvalMesh1" );
	qglEvalMesh2                 = 	dllEvalMesh2                 = (void ( APIENTRY *)(GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2))GPA( "glEvalMesh2" );
	qglEvalPoint1                = 	dllEvalPoint1                = (void ( APIENTRY *)(GLint i))GPA( "glEvalPoint1" );
	qglEvalPoint2                = 	dllEvalPoint2                = (void ( APIENTRY *)(GLint i, GLint j))GPA( "glEvalPoint2" );
	qglFeedbackBuffer            = 	dllFeedbackBuffer            = (void ( APIENTRY *)(GLsizei size, GLenum type, GLfloat *buffer))GPA( "glFeedbackBuffer" );
	qglFinish                    = 	dllFinish                    = (void ( APIENTRY *)(void))GPA( "glFinish" );
	qglFlush                     = 	dllFlush                     = (void ( APIENTRY *)(void))GPA( "glFlush" );
	qglFogf                      = 	dllFogf                      = (void ( APIENTRY *)(GLenum pname, GLfloat param))GPA( "glFogf" );
	qglFogfv                     = 	dllFogfv                     = (void ( APIENTRY *)(GLenum pname, const GLfloat *params))GPA( "glFogfv" );
	qglFogi                      = 	dllFogi                      = (void ( APIENTRY *)(GLenum pname, GLint param))GPA( "glFogi" );
	qglFogiv                     = 	dllFogiv                     = (void ( APIENTRY *)(GLenum pname, const GLint *params))GPA( "glFogiv" );
	qglFrontFace                 = 	dllFrontFace                 = (void ( APIENTRY *)(GLenum mode))GPA( "glFrontFace" );
	qglFrustum                   = 	dllFrustum                   = (void ( APIENTRY *)(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar))GPA( "glFrustum" );
	qglGenLists                  = 	dllGenLists                  = (GLuint ( APIENTRY *)(GLsizei range)) GPA( "glGenLists" );
	qglGenTextures               = 	dllGenTextures               = (void ( APIENTRY *)(GLsizei n, GLuint *textures))GPA( "glGenTextures" );
	qglGetBooleanv               = 	dllGetBooleanv               = (void ( APIENTRY *)(GLenum pname, GLboolean *params))GPA( "glGetBooleanv" );
	qglGetClipPlane              = 	dllGetClipPlane              = (void ( APIENTRY *)(GLenum plane, GLdouble *equation))GPA( "glGetClipPlane" );
	qglGetDoublev                = 	dllGetDoublev                = (void ( APIENTRY *)(GLenum pname, GLdouble *params))GPA( "glGetDoublev" );
	qglGetError                  = 	dllGetError                  = (GLenum ( APIENTRY *)(void)) GPA( "glGetError" );
	qglGetFloatv                 = 	dllGetFloatv                 = (void ( APIENTRY *)(GLenum pname, GLfloat *params))GPA( "glGetFloatv" );
	qglGetIntegerv               = 	dllGetIntegerv               = (void ( APIENTRY *)(GLenum pname, GLint *params))GPA( "glGetIntegerv" );
	qglGetLightfv                = 	dllGetLightfv                = (void ( APIENTRY *)(GLenum light, GLenum pname, GLfloat *params))GPA( "glGetLightfv" );
	qglGetLightiv                = 	dllGetLightiv                = (void ( APIENTRY *)(GLenum light, GLenum pname, GLint *params))GPA( "glGetLightiv" );
	qglGetMapdv                  = 	dllGetMapdv                  = (void ( APIENTRY *)(GLenum target, GLenum query, GLdouble *v))GPA( "glGetMapdv" );
	qglGetMapfv                  = 	dllGetMapfv                  = (void ( APIENTRY *)(GLenum target, GLenum query, GLfloat *v))GPA( "glGetMapfv" );
	qglGetMapiv                  = 	dllGetMapiv                  = (void ( APIENTRY *)(GLenum target, GLenum query, GLint *v))GPA( "glGetMapiv" );
	qglGetMaterialfv             = 	dllGetMaterialfv             = (void ( APIENTRY *)(GLenum face, GLenum pname, GLfloat *params))GPA( "glGetMaterialfv" );
	qglGetMaterialiv             = 	dllGetMaterialiv             = (void ( APIENTRY *)(GLenum face, GLenum pname, GLint *params))GPA( "glGetMaterialiv" );
	qglGetPixelMapfv             = 	dllGetPixelMapfv             = (void ( APIENTRY *)(GLenum map, GLfloat *values))GPA( "glGetPixelMapfv" );
	qglGetPixelMapuiv            = 	dllGetPixelMapuiv            = (void ( APIENTRY *)(GLenum map, GLuint *values))GPA( "glGetPixelMapuiv" );
	qglGetPixelMapusv            = 	dllGetPixelMapusv            = (void ( APIENTRY *)(GLenum map, GLushort *values))GPA( "glGetPixelMapusv" );
	qglGetPointerv               = 	dllGetPointerv               = (void ( APIENTRY *)(GLenum pname, GLvoid* *params))GPA( "glGetPointerv" );
	qglGetPolygonStipple         = 	dllGetPolygonStipple         = (void ( APIENTRY *)(GLubyte *mask))GPA( "glGetPolygonStipple" );
	qglGetString                 = 	dllGetString                 = (const GLubyte * ( APIENTRY *)(GLenum name))GPA( "glGetString" );
	qglGetTexEnvfv               = 	dllGetTexEnvfv               = (void ( APIENTRY *)(GLenum target, GLenum pname, GLfloat *params))GPA( "glGetTexEnvfv" );
	qglGetTexEnviv               = 	dllGetTexEnviv               = (void ( APIENTRY *)(GLenum target, GLenum pname, GLint *params))GPA( "glGetTexEnviv" );
	qglGetTexGendv               = 	dllGetTexGendv               = (void ( APIENTRY *)(GLenum coord, GLenum pname, GLdouble *params))GPA( "glGetTexGendv" );
	qglGetTexGenfv               = 	dllGetTexGenfv               = (void ( APIENTRY *)(GLenum coord, GLenum pname, GLfloat *params))GPA( "glGetTexGenfv" );
	qglGetTexGeniv               = 	dllGetTexGeniv               = (void ( APIENTRY *)(GLenum coord, GLenum pname, GLint *params))GPA( "glGetTexGeniv" );
	qglGetTexImage               = 	dllGetTexImage               = (void ( APIENTRY *)(GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels))GPA( "glGetTexImage" );
	qglGetTexLevelParameterfv    = 	dllGetTexLevelParameterfv    = (void ( APIENTRY *)(GLenum target, GLint level, GLenum pname, GLfloat *params))GPA( "glGetLevelParameterfv" );
	qglGetTexLevelParameteriv    = 	dllGetTexLevelParameteriv    = (void ( APIENTRY *)(GLenum target, GLint level, GLenum pname, GLint *params))GPA( "glGetLevelParameteriv" );
	qglGetTexParameterfv         = 	dllGetTexParameterfv         = (void ( APIENTRY *)(GLenum target, GLenum pname, GLfloat *params))GPA( "glGetTexParameterfv" );
	qglGetTexParameteriv         = 	dllGetTexParameteriv         = (void ( APIENTRY *)(GLenum target, GLenum pname, GLint *params))GPA( "glGetTexParameteriv" );
	qglHint                      = 	dllHint                      = (void ( APIENTRY *)(GLenum target, GLenum mode))GPA( "glHint" );
	qglIndexMask                 = 	dllIndexMask                 = (void ( APIENTRY *)(GLuint mask))GPA( "glIndexMask" );
	qglIndexPointer              = 	dllIndexPointer              = (void ( APIENTRY *)(GLenum type, GLsizei stride, const GLvoid *pointer))GPA( "glIndexPointer" );
	qglIndexd                    = 	dllIndexd                    = (void ( APIENTRY *)(GLdouble c))GPA( "glIndexd" );
	qglIndexdv                   = 	dllIndexdv                   = (void ( APIENTRY *)(const GLdouble *c))GPA( "glIndexdv" );
	qglIndexf                    = 	dllIndexf                    = (void ( APIENTRY *)(GLfloat c))GPA( "glIndexf" );
	qglIndexfv                   = 	dllIndexfv                   = (void ( APIENTRY *)(const GLfloat *c))GPA( "glIndexfv" );
	qglIndexi                    = 	dllIndexi                    = (void ( APIENTRY *)(GLint c))GPA( "glIndexi" );
	qglIndexiv                   = 	dllIndexiv                   = (void ( APIENTRY *)(const GLint *c))GPA( "glIndexiv" );
	qglIndexs                    = 	dllIndexs                    = (void ( APIENTRY *)(GLshort c))GPA( "glIndexs" );
	qglIndexsv                   = 	dllIndexsv                   = (void ( APIENTRY *)(const GLshort *c))GPA( "glIndexsv" );
	qglIndexub                   = 	dllIndexub                   = (void ( APIENTRY *)(GLubyte c))GPA( "glIndexub" );
	qglIndexubv                  = 	dllIndexubv                  = (void ( APIENTRY *)(const GLubyte *c))GPA( "glIndexubv" );
	qglInitNames                 = 	dllInitNames                 = (void ( APIENTRY *)(void))GPA( "glInitNames" );
	qglInterleavedArrays         = 	dllInterleavedArrays         = (void ( APIENTRY *)(GLenum format, GLsizei stride, const GLvoid *pointer))GPA( "glInterleavedArrays" );
	qglIsEnabled                 = 	dllIsEnabled                 = (GLboolean ( APIENTRY *)(GLenum cap))GPA( "glIsEnabled" );
	qglIsList                    = 	dllIsList                    = (GLboolean ( APIENTRY *)(GLuint list))GPA( "glIsList" );
	qglIsTexture                 = 	dllIsTexture                 = (GLboolean ( APIENTRY *)(GLuint texture))GPA( "glIsTexture" );
	qglLightModelf               = 	dllLightModelf               = (void ( APIENTRY *)(GLenum pname, GLfloat param))GPA( "glLightModelf" );
	qglLightModelfv              = 	dllLightModelfv              = (void ( APIENTRY *)(GLenum pname, const GLfloat *params))GPA( "glLightModelfv" );
	qglLightModeli               = 	dllLightModeli               = (void ( APIENTRY *)(GLenum pname, GLint param))GPA( "glLightModeli" );
	qglLightModeliv              = 	dllLightModeliv              = (void ( APIENTRY *)(GLenum pname, const GLint *params))GPA( "glLightModeliv" );
	qglLightf                    = 	dllLightf                    = (void ( APIENTRY *)(GLenum light, GLenum pname, GLfloat param))GPA( "glLightf" );
	qglLightfv                   = 	dllLightfv                   = (void ( APIENTRY *)(GLenum light, GLenum pname, const GLfloat *params))GPA( "glLightfv" );
	qglLighti                    = 	dllLighti                    = (void ( APIENTRY *)(GLenum light, GLenum pname, GLint param))GPA( "glLighti" );
	qglLightiv                   = 	dllLightiv                   = (void ( APIENTRY *)(GLenum light, GLenum pname, const GLint *params))GPA( "glLightiv" );
	qglLineStipple               = 	dllLineStipple               = (void ( APIENTRY *)(GLint factor, GLushort pattern))GPA( "glLineStipple" );
	qglLineWidth                 = 	dllLineWidth                 = (void ( APIENTRY *)(GLfloat width))GPA( "glLineWidth" );
	qglListBase                  = 	dllListBase                  = (void ( APIENTRY *)(GLuint base))GPA( "glListBase" );
	qglLoadIdentity              = 	dllLoadIdentity              = (void ( APIENTRY *)(void))GPA( "glLoadIdentity" );
	qglLoadMatrixd               = 	dllLoadMatrixd               = (void ( APIENTRY *)(const GLdouble *m))GPA( "glLoadMatrixd" );
	qglLoadMatrixf               = 	dllLoadMatrixf               = (void ( APIENTRY *)(const GLfloat *m))GPA( "glLoadMatrixf" );
	qglLoadName                  = 	dllLoadName                  = (void ( APIENTRY *)(GLuint name))GPA( "glLoadName" );
	qglLogicOp                   = 	dllLogicOp                   = (void ( APIENTRY *)(GLenum opcode))GPA( "glLogicOp" );
	qglMap1d                     = 	dllMap1d                     = (void ( APIENTRY *)(GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points))GPA( "glMap1d" );
	qglMap1f                     = 	dllMap1f                     = (void ( APIENTRY *)(GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points))GPA( "glMap1f" );
	qglMap2d                     = 	dllMap2d                     = (void ( APIENTRY *)(GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points))GPA( "glMap2d" );
	qglMap2f                     = 	dllMap2f                     = (void ( APIENTRY *)(GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points))GPA( "glMap2f" );
	qglMapGrid1d                 = 	dllMapGrid1d                 = (void ( APIENTRY *)(GLint un, GLdouble u1, GLdouble u2))GPA( "glMapGrid1d" );
	qglMapGrid1f                 = 	dllMapGrid1f                 = (void ( APIENTRY *)(GLint un, GLfloat u1, GLfloat u2))GPA( "glMapGrid1f" );
	qglMapGrid2d                 = 	dllMapGrid2d                 = (void ( APIENTRY *)(GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2))GPA( "glMapGrid2d" );
	qglMapGrid2f                 = 	dllMapGrid2f                 = (void ( APIENTRY *)(GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2))GPA( "glMapGrid2f" );
	qglMaterialf                 = 	dllMaterialf                 = (void ( APIENTRY *)(GLenum face, GLenum pname, GLfloat param))GPA( "glMaterialf" );
	qglMaterialfv                = 	dllMaterialfv                = (void ( APIENTRY *)(GLenum face, GLenum pname, const GLfloat *params))GPA( "glMaterialfv" );
	qglMateriali                 = 	dllMateriali                 = (void ( APIENTRY *)(GLenum face, GLenum pname, GLint param))GPA( "glMateriali" );
	qglMaterialiv                = 	dllMaterialiv                = (void ( APIENTRY *)(GLenum face, GLenum pname, const GLint *params))GPA( "glMaterialiv" );
	qglMatrixMode                = 	dllMatrixMode                = (void ( APIENTRY *)(GLenum mode))GPA( "glMatrixMode" );
	qglMultMatrixd               = 	dllMultMatrixd               = (void ( APIENTRY *)(const GLdouble *m))GPA( "glMultMatrixd" );
	qglMultMatrixf               = 	dllMultMatrixf               = (void ( APIENTRY *)(const GLfloat *m))GPA( "glMultMatrixf" );
	qglNewList                   = 	dllNewList                   = (void ( APIENTRY *)(GLuint list, GLenum mode))GPA( "glNewList" );
	qglNormal3b                  = 	dllNormal3b                  = (void ( APIENTRY *)(GLbyte nx, GLbyte ny, GLbyte nz))GPA( "glNormal3b" );
	qglNormal3bv                 = 	dllNormal3bv                 = (void ( APIENTRY *)(const GLbyte *v))GPA( "glNormal3bv" );
	qglNormal3d                  = 	dllNormal3d                  = (void ( APIENTRY *)(GLdouble nx, GLdouble ny, GLdouble nz))GPA( "glNormal3d" );
	qglNormal3dv                 = 	dllNormal3dv                 = (void ( APIENTRY *)(const GLdouble *v))GPA( "glNormal3dv" );
	qglNormal3f                  = 	dllNormal3f                  = (void ( APIENTRY *)(GLfloat nx, GLfloat ny, GLfloat nz))GPA( "glNormal3f" );
	qglNormal3fv                 = 	dllNormal3fv                 = (void ( APIENTRY *)(const GLfloat *v))GPA( "glNormal3fv" );
	qglNormal3i                  = 	dllNormal3i                  = (void ( APIENTRY *)(GLint nx, GLint ny, GLint nz))GPA( "glNormal3i" );
	qglNormal3iv                 = 	dllNormal3iv                 = (void ( APIENTRY *)(const GLint *v))GPA( "glNormal3iv" );
	qglNormal3s                  = 	dllNormal3s                  = (void ( APIENTRY *)(GLshort nx, GLshort ny, GLshort nz))GPA( "glNormal3s" );
	qglNormal3sv                 = 	dllNormal3sv                 = (void ( APIENTRY *)(const GLshort *v))GPA( "glNormal3sv" );
	qglNormalPointer             = 	dllNormalPointer             = (void ( APIENTRY *)(GLenum type, GLsizei stride, const GLvoid *pointer))GPA( "glNormalPointer" );
	qglOrtho                     = 	dllOrtho                     = (void ( APIENTRY *)(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar))GPA( "glOrtho" );
	qglPassThrough               = 	dllPassThrough               = (void ( APIENTRY *)(GLfloat token))GPA( "glPassThrough" );
	qglPixelMapfv                = 	dllPixelMapfv                = (void ( APIENTRY *)(GLenum map, GLsizei mapsize, const GLfloat *values))GPA( "glPixelMapfv" );
	qglPixelMapuiv               = 	dllPixelMapuiv               = (void ( APIENTRY *)(GLenum map, GLsizei mapsize, const GLuint *values))GPA( "glPixelMapuiv" );
	qglPixelMapusv               = 	dllPixelMapusv               = (void ( APIENTRY *)(GLenum map, GLsizei mapsize, const GLushort *values))GPA( "glPixelMapusv" );
	qglPixelStoref               = 	dllPixelStoref               = (void ( APIENTRY *)(GLenum pname, GLfloat param))GPA( "glPixelStoref" );
	qglPixelStorei               = 	dllPixelStorei               = (void ( APIENTRY *)(GLenum pname, GLint param))GPA( "glPixelStorei" );
	qglPixelTransferf            = 	dllPixelTransferf            = (void ( APIENTRY *)(GLenum pname, GLfloat param))GPA( "glPixelTransferf" );
	qglPixelTransferi            = 	dllPixelTransferi            = (void ( APIENTRY *)(GLenum pname, GLint param))GPA( "glPixelTransferi" );
	qglPixelZoom                 = 	dllPixelZoom                 = (void ( APIENTRY *)(GLfloat xfactor, GLfloat yfactor))GPA( "glPixelZoom" );
	qglPointSize                 = 	dllPointSize                 = (void ( APIENTRY *)(GLfloat size))GPA( "glPointSize" );
	qglPolygonMode               = 	dllPolygonMode               = (void ( APIENTRY *)(GLenum face, GLenum mode))GPA( "glPolygonMode" );
	qglPolygonOffset             = 	dllPolygonOffset             = (void ( APIENTRY *)(GLfloat factor, GLfloat units))GPA( "glPolygonOffset" );
	qglPolygonStipple            = 	dllPolygonStipple            = (void ( APIENTRY *)(const GLubyte *mask))GPA( "glPolygonStipple" );
	...
	qglPrioritizeTextures        = 	dllPrioritizeTextures        = (void ( APIENTRY *)(GLsizei n, const GLuint *textures, const GLclampf *priorities))GPA( "glPrioritizeTextures" );
	qglPushAttrib                = 	dllPushAttrib                = (void ( APIENTRY *)(GLbitfield mask))GPA( "glPushAttrib" );
	qglPushClientAttrib          = 	dllPushClientAttrib          = (void ( APIENTRY *)(GLbitfield mask))GPA( "glPushClientAttrib" );
	qglPushMatrix                = 	dllPushMatrix                = (void ( APIENTRY *)(void))GPA( "glPushMatrix" );
	qglPushName                  = 	dllPushName                  = (void ( APIENTRY *)(GLuint name))GPA( "glPushName" );
	qglRasterPos2d               = 	dllRasterPos2d               = (void ( APIENTRY *)(GLdouble x, GLdouble y))GPA( "glRasterPos2d" );
	qglRasterPos2dv              = 	dllRasterPos2dv              = (void ( APIENTRY *)(const GLdouble *v))GPA( "glRasterPos2dv" );
	qglRasterPos2f               = 	dllRasterPos2f               = (void ( APIENTRY *)(GLfloat x, GLfloat y))GPA( "glRasterPos2f" );
	qglRasterPos2fv              = 	dllRasterPos2fv              = (void ( APIENTRY *)(const GLfloat *v))GPA( "glRasterPos2fv" );
	qglRasterPos2i               = 	dllRasterPos2i               = (void ( APIENTRY *)(GLint x, GLint y))GPA( "glRasterPos2i" );
	qglRasterPos2iv              = 	dllRasterPos2iv              = (void ( APIENTRY *)(const GLint *v))GPA( "glRasterPos2iv" );
	qglRasterPos2s               = 	dllRasterPos2s               = (void ( APIENTRY *)(GLshort x, GLshort y))GPA( "glRasterPos2s" );
	qglRasterPos2sv              = 	dllRasterPos2sv              = (void ( APIENTRY *)(const GLshort *v))GPA( "glRasterPos2sv" );
	qglRasterPos3d               = 	dllRasterPos3d               = (void ( APIENTRY *)(GLdouble x, GLdouble y, GLdouble z))GPA( "glRasterPos3d" );
	qglRasterPos3dv              = 	dllRasterPos3dv              = (void ( APIENTRY *)(const GLdouble *v))GPA( "glRasterPos3dv" );
	qglRasterPos3f               = 	dllRasterPos3f               = (void ( APIENTRY *)(GLfloat x, GLfloat y, GLfloat z))GPA( "glRasterPos3f" );
	qglRasterPos3fv              = 	dllRasterPos3fv              = (void ( APIENTRY *)(const GLfloat *v))GPA( "glRasterPos3fv" );
	qglRasterPos3i               = 	dllRasterPos3i               = (void ( APIENTRY *)(GLint x, GLint y, GLint z))GPA( "glRasterPos3i" );
	qglRasterPos3iv              = 	dllRasterPos3iv              = (void ( APIENTRY *)(const GLint *v))GPA( "glRasterPos3iv" );
	qglRasterPos3s               = 	dllRasterPos3s               = (void ( APIENTRY *)(GLshort x, GLshort y, GLshort z))GPA( "glRasterPos3s" );
	qglRasterPos3sv              = 	dllRasterPos3sv              = (void ( APIENTRY *)(const GLshort *v))GPA( "glRasterPos3sv" );
	qglRasterPos4d               = 	dllRasterPos4d               = (void ( APIENTRY *)(GLdouble x, GLdouble y, GLdouble z, GLdouble w))GPA( "glRasterPos4d" );
	qglRasterPos4dv              = 	dllRasterPos4dv              = (void ( APIENTRY *)(const GLdouble *v))GPA( "glRasterPos4dv" );
	qglRasterPos4f               = 	dllRasterPos4f               = (void ( APIENTRY *)(GLfloat x, GLfloat y, GLfloat z, GLfloat w))GPA( "glRasterPos4f" );
	qglRasterPos4fv              = 	dllRasterPos4fv              = (void ( APIENTRY *)(const GLfloat *v))GPA( "glRasterPos4fv" );
	qglRasterPos4i               = 	dllRasterPos4i               = (void ( APIENTRY *)(GLint x, GLint y, GLint z, GLint w))GPA( "glRasterPos4i" );
	qglRasterPos4iv              = 	dllRasterPos4iv              = (void ( APIENTRY *)(const GLint *v))GPA( "glRasterPos4iv" );
	qglRasterPos4s               = 	dllRasterPos4s               = (void ( APIENTRY *)(GLshort x, GLshort y, GLshort z, GLshort w))GPA( "glRasterPos4s" );
	qglRasterPos4sv              = 	dllRasterPos4sv              = (void ( APIENTRY *)(const GLshort *v))GPA( "glRasterPos4sv" );
	qglReadBuffer                = 	dllReadBuffer                = (void ( APIENTRY *)(GLenum mode))GPA( "glReadBuffer" );
	qglReadPixels                = 	dllReadPixels                = (void ( APIENTRY *)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels))GPA( "glReadPixels" );
	qglRectd                     = 	dllRectd                     = (void ( APIENTRY *)(GLdouble x1, GLdouble y1, GLdouble x2, GLdouble y2))GPA( "glRectd" );
	qglRectdv                    = 	dllRectdv                    = (void ( APIENTRY *)(const GLdouble *v1, const GLdouble *v2))GPA( "glRectdv" );
	qglRectf                     = 	dllRectf                     = (void ( APIENTRY *)(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2))GPA( "glRectf" );
	qglRectfv                    = 	dllRectfv                    = (void ( APIENTRY *)(const GLfloat *v1, const GLfloat *v2))GPA( "glRectfv" );
	qglRecti                     = 	dllRecti                     = (void ( APIENTRY *)(GLint x1, GLint y1, GLint x2, GLint y2))GPA( "glRecti" );
	qglRectiv                    = 	dllRectiv                    = (void ( APIENTRY *)(const GLint *v1, const GLint *v2))GPA( "glRectiv" );
	qglRects                     = 	dllRects                     = (void ( APIENTRY *)(GLshort x1, GLshort y1, GLshort x2, GLshort y2))GPA( "glRects" );
	qglRectsv                    = 	dllRectsv                    = (void ( APIENTRY *)(const GLshort *v1, const GLshort *v2))GPA( "glRectsv" );
	qglRenderMode                = 	dllRenderMode                = (GLint ( APIENTRY *)(GLenum mode))GPA( "glRenderMode" );
	qglRotated                   = 	dllRotated                   = (void ( APIENTRY *)(GLdouble angle, GLdouble x, GLdouble y, GLdouble z))GPA( "glRotated" );
	qglRotatef                   = 	dllRotatef                   = (void ( APIENTRY *)(GLfloat angle, GLfloat x, GLfloat y, GLfloat z))GPA( "glRotatef" );
	qglScaled                    = 	dllScaled                    = (void ( APIENTRY *)(GLdouble x, GLdouble y, GLdouble z))GPA( "glScaled" );
	qglScalef                    = 	dllScalef                    = (void ( APIENTRY *)(GLfloat x, GLfloat y, GLfloat z))GPA( "glScalef" );
	qglScissor                   = 	dllScissor                   = (void ( APIENTRY *)(GLint x, GLint y, GLsizei width, GLsizei height))GPA( "glScissor" );
	qglSelectBuffer              = 	dllSelectBuffer              = (void ( APIENTRY *)(GLsizei size, GLuint *buffer))GPA( "glSelectBuffer" );
	qglShadeModel                = 	dllShadeModel                = (void ( APIENTRY *)(GLenum mode))GPA( "glShadeModel" );
	qglStencilFunc               = 	dllStencilFunc               = (void ( APIENTRY *)(GLenum func, GLint ref, GLuint mask))GPA( "glStencilFunc" );
	qglStencilMask               = 	dllStencilMask               = (void ( APIENTRY *)(GLuint mask))GPA( "glStencilMask" );
	qglStencilOp                 = 	dllStencilOp                 = (void ( APIENTRY *)(GLenum fail, GLenum zfail, GLenum zpass))GPA( "glStencilOp" );
	qglTexCoord1d                = 	dllTexCoord1d                = (void ( APIENTRY *)(GLdouble s))GPA( "glTexCoord1d" );
	qglTexCoord1dv               = 	dllTexCoord1dv               = (void ( APIENTRY *)(const GLdouble *v))GPA( "glTexCoord1dv" );
	qglTexCoord1f                = 	dllTexCoord1f                = (void ( APIENTRY *)(GLfloat s))GPA( "glTexCoord1f" );
	qglTexCoord1fv               = 	dllTexCoord1fv               = (void ( APIENTRY *)(const GLfloat *v))GPA( "glTexCoord1fv" );
	qglTexCoord1i                = 	dllTexCoord1i                = (void ( APIENTRY *)(GLint s))GPA( "glTexCoord1i" );
	qglTexCoord1iv               = 	dllTexCoord1iv               = (void ( APIENTRY *)(const GLint *v))GPA( "glTexCoord1iv" );
	qglTexCoord1s                = 	dllTexCoord1s                = (void ( APIENTRY *)(GLshort s))GPA( "glTexCoord1s" );
	qglTexCoord1sv               = 	dllTexCoord1sv               = (void ( APIENTRY *)(const GLshort *v))GPA( "glTexCoord1sv" );
	qglTexCoord2d                = 	dllTexCoord2d                = (void ( APIENTRY *)(GLdouble s, GLdouble t))GPA( "glTexCoord2d" );
	qglTexCoord2dv               = 	dllTexCoord2dv               = (void ( APIENTRY *)(const GLdouble *v))GPA( "glTexCoord2dv" );
	qglTexCoord2f                = 	dllTexCoord2f                = (void ( APIENTRY *)(GLfloat s, GLfloat t))GPA( "glTexCoord2f" );
	qglTexCoord2fv               = 	dllTexCoord2fv               = (void ( APIENTRY *)(const GLfloat *v))GPA( "glTexCoord2fv" );
	qglTexCoord2i                = 	dllTexCoord2i                = (void ( APIENTRY *)(GLint s, GLint t))GPA( "glTexCoord2i" );
	qglTexCoord2iv               = 	dllTexCoord2iv               = (void ( APIENTRY *)(const GLint *v))GPA( "glTexCoord2iv" );
	qglTexCoord2s                = 	dllTexCoord2s                = (void ( APIENTRY *)(GLshort s, GLshort t))GPA( "glTexCoord2s" );
	qglTexCoord2sv               = 	dllTexCoord2sv               = (void ( APIENTRY *)(const GLshort *v))GPA( "glTexCoord2sv" );
	qglTexCoord3d                = 	dllTexCoord3d                = (void ( APIENTRY *)(GLdouble s, GLdouble t, GLdouble r))GPA( "glTexCoord3d" );
	qglTexCoord3dv               = 	dllTexCoord3dv               = (void ( APIENTRY *)(const GLdouble *v))GPA( "glTexCoord3dv" );
	qglTexCoord3f                = 	dllTexCoord3f                = (void ( APIENTRY *)(GLfloat s, GLfloat t, GLfloat r))GPA( "glTexCoord3f" );
	qglTexCoord3fv               = 	dllTexCoord3fv               = (void ( APIENTRY *)(const GLfloat *v))GPA( "glTexCoord3fv" );
	qglTexCoord3i                = 	dllTexCoord3i                = (void ( APIENTRY *)(GLint s, GLint t, GLint r))GPA( "glTexCoord3i" );
	qglTexCoord3iv               = 	dllTexCoord3iv               = (void ( APIENTRY *)(const GLint *v))GPA( "glTexCoord3iv" );
	qglTexCoord3s                = 	dllTexCoord3s                = (void ( APIENTRY *)(GLshort s, GLshort t, GLshort r))GPA( "glTexCoord3s" );
	qglTexCoord3sv               = 	dllTexCoord3sv               = (void ( APIENTRY *)(const GLshort *v))GPA( "glTexCoord3sv" );
	qglTexCoord4d                = 	dllTexCoord4d                = (void ( APIENTRY *)(GLdouble s, GLdouble t, GLdouble r, GLdouble q))GPA( "glTexCoord4d" );
	qglTexCoord4dv               = 	dllTexCoord4dv               = (void ( APIENTRY *)(const GLdouble *v))GPA( "glTexCoord4dv" );
	qglTexCoord4f                = 	dllTexCoord4f                = (void ( APIENTRY *)(GLfloat s, GLfloat t, GLfloat r, GLfloat q))GPA( "glTexCoord4f" );
	qglTexCoord4fv               = 	dllTexCoord4fv               = (void ( APIENTRY *)(const GLfloat *v))GPA( "glTexCoord4fv" );
	qglTexCoord4i                = 	dllTexCoord4i                = (void ( APIENTRY *)(GLint s, GLint t, GLint r, GLint q))GPA( "glTexCoord4i" );
	qglTexCoord4iv               = 	dllTexCoord4iv               = (void ( APIENTRY *)(const GLint *v))GPA( "glTexCoord4iv" );
	qglTexCoord4s                = 	dllTexCoord4s                = (void ( APIENTRY *)(GLshort s, GLshort t, GLshort r, GLshort q))GPA( "glTexCoord4s" );
	qglTexCoord4sv               = 	dllTexCoord4sv               = (void ( APIENTRY *)(const GLshort *v))GPA( "glTexCoord4sv" );
	qglTexCoordPointer           = 	dllTexCoordPointer           = (void ( APIENTRY *)(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer))GPA( "glTexCoordPointer" );
	qglTexEnvf                   = 	dllTexEnvf                   = (void ( APIENTRY *)(GLenum target, GLenum pname, GLfloat param))GPA( "glTexEnvf" );
	qglTexEnvfv                  = 	dllTexEnvfv                  = (void ( APIENTRY *)(GLenum target, GLenum pname, const GLfloat *params))GPA( "glTexEnvfv" );
	qglTexEnvi                   = 	dllTexEnvi                   = (void ( APIENTRY *)(GLenum target, GLenum pname, GLint param))GPA( "glTexEnvi" );
	qglTexEnviv                  = 	dllTexEnviv                  = (void ( APIENTRY *)(GLenum target, GLenum pname, const GLint *params))GPA( "glTexEnviv" );
	qglTexGend                   = 	dllTexGend                   = (void ( APIENTRY *)(GLenum coord, GLenum pname, GLdouble param))GPA( "glTexGend" );
	qglTexGendv                  = 	dllTexGendv                  = (void ( APIENTRY *)(GLenum coord, GLenum pname, const GLdouble *params))GPA( "glTexGendv" );
	qglTexGenf                   = 	dllTexGenf                   = (void ( APIENTRY *)(GLenum coord, GLenum pname, GLfloat param))GPA( "glTexGenf" );
	qglTexGenfv                  = 	dllTexGenfv                  = (void ( APIENTRY *)(GLenum coord, GLenum pname, const GLfloat *params))GPA( "glTexGenfv" );
	qglTexGeni                   = 	dllTexGeni                   = (void ( APIENTRY *)(GLenum coord, GLenum pname, GLint param))GPA( "glTexGeni" );
	qglTexGeniv                  = 	dllTexGeniv                  = (void ( APIENTRY *)(GLenum coord, GLenum pname, const GLint *params))GPA( "glTexGeniv" );
	qglTexImage1D                = 	dllTexImage1D                = (void ( APIENTRY *)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glTexImage1D" );
	qglTexImage2D                = 	dllTexImage2D                = (void ( APIENTRY *)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glTexImage2D" );
	qglTexParameterf             = 	dllTexParameterf             = (void ( APIENTRY *)(GLenum target, GLenum pname, GLfloat param))GPA( "glTexParameterf" );
	qglTexParameterfv            = 	dllTexParameterfv            = (void ( APIENTRY *)(GLenum target, GLenum pname, const GLfloat *params))GPA( "glTexParameterfv" );
	qglTexParameteri             = 	dllTexParameteri             = (void ( APIENTRY *)(GLenum target, GLenum pname, GLint param))GPA( "glTexParameteri" );
	qglTexParameteriv            = 	dllTexParameteriv            = (void ( APIENTRY *)(GLenum target, GLenum pname, const GLint *params))GPA( "glTexParameteriv" );
	qglTexSubImage1D             = 	dllTexSubImage1D             = (void ( APIENTRY *)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glTexSubImage1D" );
	qglTexSubImage2D             = 	dllTexSubImage2D             = (void ( APIENTRY *)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glTexSubImage2D" );
	qglTranslated                = 	dllTranslated                = (void ( APIENTRY *)(GLdouble x, GLdouble y, GLdouble z))GPA( "glTranslated" );
	qglTranslatef                = 	dllTranslatef                = (void ( APIENTRY *)(GLfloat x, GLfloat y, GLfloat z))GPA( "glTranslatef" );
	qglVertex2d                  = 	dllVertex2d                  = (void ( APIENTRY *)(GLdouble x, GLdouble y))GPA( "glVertex2d" );
	qglVertex2dv                 = 	dllVertex2dv                 = (void ( APIENTRY *)(const GLdouble *v))GPA( "glVertex2dv" );
	qglVertex2f                  = 	dllVertex2f                  = (void ( APIENTRY *)(GLfloat x, GLfloat y))GPA( "glVertex2f" );
	qglVertex2fv                 = 	dllVertex2fv                 = (void ( APIENTRY *)(const GLfloat *v))GPA( "glVertex2fv" );
	qglVertex2i                  = 	dllVertex2i                  = (void ( APIENTRY *)(GLint x, GLint y))GPA( "glVertex2i" );
	qglVertex2iv                 = 	dllVertex2iv                 = (void ( APIENTRY *)(const GLint *v))GPA( "glVertex2iv" );
	qglVertex2s                  = 	dllVertex2s                  = (void ( APIENTRY *)(GLshort x, GLshort y))GPA( "glVertex2s" );
	qglVertex2sv                 = 	dllVertex2sv                 = (void ( APIENTRY *)(const GLshort *v))GPA( "glVertex2sv" );
	qglVertex3d                  = 	dllVertex3d                  = (void ( APIENTRY *)(GLdouble x, GLdouble y, GLdouble z))GPA( "glVertex3d" );
	qglVertex3dv                 = 	dllVertex3dv                 = (void ( APIENTRY *)(const GLdouble *v))GPA( "glVertex3dv" );
	qglVertex3f                  = 	dllVertex3f                  = (void ( APIENTRY *)(GLfloat x, GLfloat y, GLfloat z))GPA( "glVertex3f" );
	qglVertex3fv                 = 	dllVertex3fv                 = (void ( APIENTRY *)(const GLfloat *v))GPA( "glVertex3fv" );
	qglVertex3i                  = 	dllVertex3i                  = (void ( APIENTRY *)(GLint x, GLint y, GLint z))GPA( "glVertex3i" );
	qglVertex3iv                 = 	dllVertex3iv                 = (void ( APIENTRY *)(const GLint *v))GPA( "glVertex3iv" );
	qglVertex3s                  = 	dllVertex3s                  = (void ( APIENTRY *)(GLshort x, GLshort y, GLshort z))GPA( "glVertex3s" );
	qglVertex3sv                 = 	dllVertex3sv                 = (void ( APIENTRY *)(const GLshort *v))GPA( "glVertex3sv" );
	qglVertex4d                  = 	dllVertex4d                  = (void ( APIENTRY *)(GLdouble x, GLdouble y, GLdouble z, GLdouble w))GPA( "glVertex4d" );
	qglVertex4dv                 = 	dllVertex4dv                 = (void ( APIENTRY *)(const GLdouble *v))GPA( "glVertex4dv" );
	qglVertex4f                  = 	dllVertex4f                  = (void ( APIENTRY *)(GLfloat x, GLfloat y, GLfloat z, GLfloat w))GPA( "glVertex4f" );
	qglVertex4fv                 = 	dllVertex4fv                 = (void ( APIENTRY *)(const GLfloat *v))GPA( "glVertex4fv" );
	qglVertex4i                  = 	dllVertex4i                  = (void ( APIENTRY *)(GLint x, GLint y, GLint z, GLint w))GPA( "glVertex4i" );
	qglVertex4iv                 = 	dllVertex4iv                 = (void ( APIENTRY *)(const GLint *v))GPA( "glVertex4iv" );
	qglVertex4s                  = 	dllVertex4s                  = (void ( APIENTRY *)(GLshort x, GLshort y, GLshort z, GLshort w))GPA( "glVertex4s" );
	qglVertex4sv                 = 	dllVertex4sv                 = (void ( APIENTRY *)(const GLshort *v))GPA( "glVertex4sv" );
	qglVertexPointer             = 	dllVertexPointer             = (void ( APIENTRY *)(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer))GPA( "glVertexPointer" );
	qglViewport                  = 	dllViewport                  = (void ( APIENTRY *)(GLint x, GLint y, GLsizei width, GLsizei height))GPA( "glViewport" );
