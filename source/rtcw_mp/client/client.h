...
typedef struct {
	...
	int cgameUserCmdValue;              // current weapon to add to wmusercmd_t
...
typedef struct {
	...
	char reliableCommands[MAX_RELIABLE_COMMANDS_WM][MAX_TOKEN_CHARS_Q3];
	...
	char serverCommands[MAX_RELIABLE_COMMANDS_WM][MAX_TOKEN_CHARS_Q3];
