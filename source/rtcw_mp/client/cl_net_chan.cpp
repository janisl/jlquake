...
static void CL_Netchan_Encode( QMsg *msg ) {
	...
	string = (byte *)clc.serverCommands[ reliableAcknowledge & ( MAX_RELIABLE_COMMANDS_WM - 1 ) ];
	index = 0;
	//
...
static void CL_Netchan_Decode( QMsg *msg ) {
	...
	string = (byte*)clc.reliableCommands[ reliableAcknowledge & ( MAX_RELIABLE_COMMANDS_WM - 1 ) ];
	index = 0;
