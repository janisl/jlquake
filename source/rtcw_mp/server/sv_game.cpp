...
wmplayerState_t* SV_GameClientNum(int num)
{
	...
	ps = (wmplayerState_t*)((byte*)sv.gameClients + sv.gameClientSize * (num));
...
qintptr SV_GameSystemCalls(qintptr* args)
{
	...
	case G_LOCATE_GAME_DATA:
		SV_LocateGameData((sharedEntity_t*)VMA(1), args[2], args[3], (wmplayerState_t*)VMA(4), args[5]);
		return 0;
	case G_DROP_CLIENT:
	...
	case BOTLIB_AI_TOUCHING_GOAL:
		return botlib_export->ai.BotTouchingGoal((float*)VMA(1), (struct bot_goal_q3_t*)VMA(2));
	...
	case BOTLIB_AI_GET_LEVEL_ITEM_GOAL:
		BotGetLevelItemGoalQ3(args[1], (char*)VMA(2), (struct bot_goal_q3_t*)VMA(3));
	...
	case BOTLIB_AI_MOVE_TO_GOAL:
		botlib_export->ai.BotMoveToGoal((struct bot_moveresult_s*)VMA(1), args[2], (struct bot_goal_q3_t*)VMA(3), args[4]);
		return 0;
