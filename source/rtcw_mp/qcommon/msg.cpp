...
=====================
*/
void MSG_WriteDeltaUsercmd(QMsg* msg, wmusercmd_t* from, wmusercmd_t* to)
{
...
=====================
*/
void MSG_ReadDeltaUsercmd(QMsg* msg, wmusercmd_t* from, wmusercmd_t* to)
{
	if (msg->ReadBits(1))
	{
...
===================
*/
void MSG_ReadDeltaPlayerstate(QMsg* msg, wmplayerState_t* from, wmplayerState_t* to)
{
	int i, j, lc;
	int bits;
	netField_t* field;
