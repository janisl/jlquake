...
#ifdef _WIN32
	{ common->FatalError("Not enough RAM allocated.  Try starting using \"-heapsize 16000\" on the QuakeWorld command line."); }
#else
	{ common->FatalError("Not enough RAM allocated.  Try starting using \"-mem 16\" on the QuakeWorld command line."); }
#endif
