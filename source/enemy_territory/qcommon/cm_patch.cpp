...
===================
*/
struct patchCollide_t *CM_GeneratePatchCollide( int width, int height, vec3_t *points, qboolean addBevels ) {
	patchCollide_t  *pf;
...
====================
*/
void CM_TracePointThroughPatchCollide( traceWork_t *tw, const struct patchCollide_t *pc ) {
