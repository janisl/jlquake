...
typedef struct {
	...
	char redirectedList[MAX_INFO_STRING_Q3];        // list of files that we downloaded through a redirect since last FS_ComparePaks
	char badChecksumList[MAX_INFO_STRING_Q3];        // list of files for which wwwdl redirect is broken (wrong checksum)
