...
/*	if ( cls.state != CA_ACTIVE ) {
	...
	if (!VM_Call(uivm, ETUI_IS_FULLSCREEN))
	{
		switch (cls.state)
		{
		default:
		...
		case CA_CONNECTED:
			...
			VM_Call(uivm, ETUI_REFRESH, cls.realtime);
			VM_Call(uivm, ETUI_DRAW_CONNECT_SCREEN, false);
			break;
...
//			}
		...
		case CA_PRIMED:
			...
			VM_Call(uivm, ETUI_REFRESH, cls.realtime);
			VM_Call(uivm, ETUI_DRAW_CONNECT_SCREEN, true);
			break;
		case CA_ACTIVE:
			CL_CGameRendering(stereoFrame);
			SCR_DrawDemoRecording();
