...
// bk001129 - from cvs1.17 (mkv)
	...
	qglXUseXFont                 =  (void ( *)( Font font, int first, int count, int list ))GPA( "glXUseXFont" );
	qglXSwapIntervalSGI = (int ( *)( int interval ))GPA( "glXSwapIntervalSGI" );
	qglXGetVideoSyncSGI = (int ( *)( unsigned int *count ))GPA( "glXGetVideoSyncSGI" );
	qglXWaitVideoSyncSGI    = (int ( *)( int divisor, int remainder, unsigned int *count ))GPA( "glXWaitVideoSyncSGI" );
	qglXQueryExtensionsString   = (const char * ( *)( Display * dpy, int screen ))GPA( "glXQueryExtensionsString" );
