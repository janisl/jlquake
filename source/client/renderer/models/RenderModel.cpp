...
idRenderModel::idRenderModel() {
	...
	brush29nm_firstmodelsurface = 0;
	brush29nm_nummodelsurfaces = 0;
	brush29nm_numsubmodels = 0;
	brush29nm_submodels = NULL;
	brush29nm_numplanes = 0;
	brush29nm_planes = NULL;
	brush29nm_numleafs = 0;
	brush29nm_leafs = NULL;
	brush29nm_numvertexes = 0;
	brush29nm_vertexes = NULL;
	brush29nm_numedges = 0;
	brush29nm_edges = NULL;
	brush29nm_numnodes = 0;
	brush29nm_firstnode = 0;
	brush29nm_nodes = NULL;
	brush29nm_numtexinfo = 0;
	brush29nm_texinfo = NULL;
	nmtextureInfos = NULL;
	brush29nm_numsurfaces = 0;
	brush29nm_surfaces = NULL;
	brush29nm_numsurfedges = 0;
	brush29nm_surfedges = NULL;
	brush29nm_nummarksurfaces = 0;
	brush29nm_marksurfaces = NULL;
	brush29nm_numtextures = 0;
	brush29nm_textures = NULL;
	brush29nm_visdata = NULL;
	brush29nm_lightdata = NULL;
	brush29nm_entities = NULL;
	q1_mdl = NULL;
	q1_spr = NULL;
	q2_numframes = 0;
	q2_flags = 0;
