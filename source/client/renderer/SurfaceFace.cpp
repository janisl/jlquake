...
void idSurfaceFace::Draw() {
	...
	for ( int i = 0; i < numIndexes; i++ ) {
		tessIndexes[ i ] = indexes[ i ] + numTessVerts;
	}
...
bool idSurfaceFace::CheckAddMarks( const vec3_t mins, const vec3_t maxs, const vec3_t dir ) const {
...
void idSurfaceFace::MarkFragments( const vec3_t projectionDir,
...
void idSurfaceFace::MarkFragmentsWolf( const vec3_t projectionDir,
	int numPlanes, const vec3_t* normals, const float* dists,
	int maxPoints, vec3_t pointBuffer,
	int maxFragments, markFragment_t* fragmentBuffer,
	int* returnedPoints, int* returnedFragments,
...
void idSurfaceFace::MarkFragmentsOldMapping( const vec3_t projectionDir,
	int numPlanes, const vec3_t* normals, const float* dists,
	int maxPoints, vec3_t pointBuffer,
	int maxFragments, markFragment_t* fragmentBuffer,
	int* returnedPoints, int* returnedFragments,
...
void idSurfaceFace::MarkFragmentsWolfMapping( const vec3_t projectionDir,
	int numPlanes, const vec3_t* normals, const float* dists,
	int maxPoints, vec3_t pointBuffer,
	int maxFragments, markFragment_t* fragmentBuffer,
	int* returnedPoints, int* returnedFragments,
...
bool idSurfaceFace::DoCull( shader_t* shader ) const {
...
int idSurfaceFace::DoMarkDynamicLights( int dlightBits ) {
