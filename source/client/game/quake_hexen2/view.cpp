...
static void VQH_AddViewModel() {
	...
	if ( GGameType & GAME_Hexen2 ) {
		...
		CLH2_SetRefEntAxis( &gun, cl.h2_viewent.state.angles, oldvec3_origin, cl.h2_viewent.state.scale, cl.h2_viewent.state.abslight, cl.h2_viewent.state.drawflags );
	...
	if ( GGameType & GAME_Hexen2 ) {
		CLH2_AddColourShadeRefEnt(&gun, cl.h2_viewent.state.colormap, cl.h2_viewent.state.drawflags );
	}
}
