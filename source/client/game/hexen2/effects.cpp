...
static void CLH2_FreeEffectChunk( int index ) {
	for ( int i = 0; i < cl.h2_Effects[ index ].Chunk.numChunks; i++ ) {
...
static void CLH2_ParseEffectRain( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Rain.min_org );
	message.ReadPos( cl.h2_Effects[ index ].Rain.max_org );
	message.ReadPos( cl.h2_Effects[ index ].Rain.e_size );
	message.ReadPos( cl.h2_Effects[ index ].Rain.dir );
	cl.h2_Effects[ index ].Rain.color = message.ReadShort();
	cl.h2_Effects[ index ].Rain.count = message.ReadShort();
	cl.h2_Effects[ index ].Rain.wait = message.ReadFloat();
}

static void CLH2_ParseEffectSnow( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Snow.min_org );
	message.ReadPos( cl.h2_Effects[ index ].Snow.max_org );
	cl.h2_Effects[ index ].Snow.flags = message.ReadByte();
	message.ReadPos( cl.h2_Effects[ index ].Snow.dir );
	cl.h2_Effects[ index ].Snow.count = message.ReadByte();
}

static void CLH2_ParseEffectFountain( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Fountain.pos );
	cl.h2_Effects[ index ].Fountain.angle[ 0 ] = message.ReadAngle();
	cl.h2_Effects[ index ].Fountain.angle[ 1 ] = message.ReadAngle();
	cl.h2_Effects[ index ].Fountain.angle[ 2 ] = message.ReadAngle();
	message.ReadPos( cl.h2_Effects[ index ].Fountain.movedir );
...
static void CLH2_ParseEffectQuake( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Quake.origin );
	cl.h2_Effects[ index ].Quake.radius = message.ReadFloat();
}

static bool CLH2_ParseEffectSmokeCommon( int index, QMsg& message, const char* modelName, int drawFlags ) {
	message.ReadPos( cl.h2_Effects[ index ].Smoke.origin );
	cl.h2_Effects[ index ].Smoke.velocity[ 0 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Smoke.velocity[ 1 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Smoke.velocity[ 2 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Smoke.framelength = message.ReadFloat();
	if ( !( GGameType & GAME_HexenWorld ) ) {
		cl.h2_Effects[ index ].Smoke.frame = message.ReadFloat();
	}

	cl.h2_Effects[ index ].Smoke.entity_index = CLH2_NewEffectEntity();
	if ( cl.h2_Effects[ index ].Smoke.entity_index == -1 ) {
		return false;
	}
...
static bool CLH2_ParseEffectTeleportSmoke1( int index, QMsg& message ) {
	...
	if ( GGameType & GAME_HexenWorld ) {
		S_StartSound( cl.h2_Effects[ index ].Smoke.origin, CLH2_TempSoundChannel(), 1, clh2_fxsfx_ravenfire, 1, 1 );

		if ( ( cl.h2_Effects[ index ].Smoke.entity_index2 = CLH2_NewEffectEntity() ) != -1 ) {
			effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Smoke.entity_index2 ];
			VectorCopy( cl.h2_Effects[ index ].Smoke.origin, ent->state.origin );
...
static bool CLHW_ParseEffectSmallExplosionWithSound( int index, QMsg& message ) {
	...
	S_StartSound( cl.h2_Effects[ index ].Smoke.origin, CLH2_TempSoundChannel(), 1, clh2_fxsfx_explode, 1, 1 );
	return true;
}
...
static bool CLH2_ParseEffectFlashCommon( int index, QMsg& message, const char* modelName ) {
	message.ReadPos( cl.h2_Effects[ index ].Flash.origin );
	cl.h2_Effects[ index ].Flash.reverse = 0;
	if ( ( cl.h2_Effects[ index ].Flash.entity_index = CLH2_NewEffectEntity() ) == -1 ) {
		return false;
	}
	effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Flash.entity_index ];
...
static void CLH2_ParseEffectRiderDeath( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].RD.origin );
}

static void CLH2_ParseEffectGravityWell( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].GravityWell.origin );
	cl.h2_Effects[ index ].GravityWell.color = message.ReadShort();
	cl.h2_Effects[ index ].GravityWell.lifetime = message.ReadFloat();
}

static void CLH2_ParseEffectTeleporterPuffs( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Teleporter.origin );
...
static void CLH2_ParseEffectTeleporterBody( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Teleporter.origin );
	cl.h2_Effects[ index ].Teleporter.velocity[ 0 ][ 0 ] = message.ReadFloat();
	...
	effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Teleporter.entity_index[ 0 ] ];
	VectorCopy( cl.h2_Effects[ index ].Teleporter.origin, ent->state.origin );
...
static bool CLH2_ParseEffectMissileCommon( int index, QMsg& message, const char* modelName ) {
	message.ReadPos( cl.h2_Effects[ index ].Missile.origin );
	cl.h2_Effects[ index ].Missile.velocity[ 0 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Missile.velocity[ 1 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Missile.velocity[ 2 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Missile.angle[ 0 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Missile.angle[ 1 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Missile.angle[ 2 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Missile.avelocity[ 0 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Missile.avelocity[ 1 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Missile.avelocity[ 2 ] = message.ReadFloat();

	if ( ( cl.h2_Effects[ index ].Missile.entity_index = CLH2_NewEffectEntity() ) == -1 ) {
		return false;
	}
	effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Missile.entity_index ];
...
static void CLH2_ParseEffectChunk( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Chunk.origin );
	cl.h2_Effects[ index ].Chunk.type = message.ReadByte();
	cl.h2_Effects[ index ].Chunk.srcVel[ 0 ] = message.ReadCoord();
	cl.h2_Effects[ index ].Chunk.srcVel[ 1 ] = message.ReadCoord();
	cl.h2_Effects[ index ].Chunk.srcVel[ 2 ] = message.ReadCoord();
	cl.h2_Effects[ index ].Chunk.numChunks = message.ReadByte();

	CLH2_InitChunkEffect( cl.h2_Effects[ index ] );
}
...
static void CLHW_ParseEffectDeathBubbles( int index, QMsg& message ) {
	cl.h2_Effects[ index ].Bubble.owner = message.ReadShort();
...
static void CLHW_ParseEffectXBowCommon( int index, QMsg& message, vec3_t origin ) {
	...
	cl.h2_Effects[ index ].Xbow.angle[ 0 ] = message.ReadAngle();
	cl.h2_Effects[ index ].Xbow.angle[ 1 ] = message.ReadAngle();
	cl.h2_Effects[ index ].Xbow.angle[ 2 ] = 0;
}

static void CLHW_ParseEffectXBowThunderbolt( int index, QMsg& message, int i, vec3_t forward2 ) {
	message.ReadPos( cl.h2_Effects[ index ].Xbow.origin[ i ] );
	vec3_t vtemp;
...
static void CLHW_InitXBowEffectEntity( int index, int i, const char* modelName ) {
	cl.h2_Effects[ index ].Xbow.ent[ i ] = CLH2_NewEffectEntity();
	if ( cl.h2_Effects[ index ].Xbow.ent[ i ] == -1 ) {
		return;
	}
...
static bool CLHW_ParseEffectDrilla( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Missile.origin );
	cl.h2_Effects[ index ].Missile.angle[ 0 ] = message.ReadAngle();
	cl.h2_Effects[ index ].Missile.angle[ 1 ] = message.ReadAngle();
	cl.h2_Effects[ index ].Missile.angle[ 2 ] = 0;
	cl.h2_Effects[ index ].Missile.speed = message.ReadShort();
	...
	cl.h2_Effects[ index ].Missile.entity_index = CLH2_NewEffectEntity();
...
static bool CLHW_ParseEffectScarabChain( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Chain.origin );
	cl.h2_Effects[ index ].Chain.owner = message.ReadShort();
	cl.h2_Effects[ index ].Chain.tag = message.ReadByte();
	...
	cl.h2_Effects[ index ].Chain.ent1 = CLH2_NewEffectEntity();
	if ( cl.h2_Effects[ index ].Chain.ent1 == -1 ) {
		return false;
	}
...
static bool CLHW_ParseEffectTripMineCommon( int index, QMsg& message ) {
	message.ReadPos( cl.h2_Effects[ index ].Chain.origin );
	cl.h2_Effects[ index ].Chain.velocity[ 0 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Chain.velocity[ 1 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Chain.velocity[ 2 ] = message.ReadFloat();
...
static bool CLHW_ParseEffectStarCommon( int index, QMsg& message ) {
	cl.h2_Effects[ index ].Star.origin[ 0 ] = message.ReadCoord();
	cl.h2_Effects[ index ].Star.origin[ 1 ] = message.ReadCoord();
	cl.h2_Effects[ index ].Star.origin[ 2 ] = message.ReadCoord();

	cl.h2_Effects[ index ].Star.velocity[ 0 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Star.velocity[ 1 ] = message.ReadFloat();
	cl.h2_Effects[ index ].Star.velocity[ 2 ] = message.ReadFloat();
	...
	cl.h2_Effects[ index ].Star.entity_index = CLH2_NewEffectEntity();
...
static bool CLHW_ParseEffectMissileStar( int index, QMsg& message ) {
	...
	cl.h2_Effects[ index ].Star.ent1 = CLH2_NewEffectEntity();
	if ( cl.h2_Effects[ index ].Star.ent1 != -1 ) {
		effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Star.ent1 ];
		VectorCopy( cl.h2_Effects[ index ].Star.origin, ent->state.origin );
		ent->state.drawflags |= H2MLS_ABSLIGHT;
	...
	cl.h2_Effects[ index ].Star.ent2 = CLH2_NewEffectEntity();
	if ( cl.h2_Effects[ index ].Star.ent2 != -1 ) {
		effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Star.ent2 ];
		VectorCopy( cl.h2_Effects[ index ].Star.origin, ent->state.origin );
		ent->model = R_RegisterModel( "models/star.mdl" );
		ent->state.drawflags |= H2MLS_ABSLIGHT;
		ent->state.abslight = 0.5;
...
void CLH2_ParseEffect( QMsg& message ) {
	...
	cl.h2_Effects[ index ].type = message.ReadByte();
...
static void CLHW_ParseMultiEffectRavenPower( QMsg& message ) {
	...
	for ( int count = 0; count < 3; count++ ) {
		int index = message.ReadByte();
		// create the effect
		cl.h2_Effects[ index ].type = HWCE_HWRAVENPOWER;
...
static void CLHW_ParseReviseEffectScarabChain( QMsg& message, int index ) {
	...
	if ( curEnt ) {
		...
		h2entity_state_t* es = CLH2_FindState( cl.h2_Effects[ index ].Chain.owner );
		if ( es ) {
			effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Chain.ent1 ];
...
static void CLHW_ParseReviseEffectXBowDirectionChange( QMsg& message, int index, int revisionCode, int curEnt ) {
	...
	CLHW_UpdateDirectionChangeVelocity( angles, cl.h2_Effects[ index ].Xbow.vel[ curEnt ] );
...
static void CLHW_ParseReviseEffectDrilla( QMsg& message, int index ) {
	...
	if ( revisionCode == 0 ) {	//impact
		...
		CLHW_UpdateDirectionChangeVelocity( angles, cl.h2_Effects[ index ].Missile.velocity );
...
static void CLHW_TurnEffectMissile( int index, float time, vec3_t position, vec3_t velocity ) {
	...
	VectorCopy( velocity, cl.h2_Effects[ index ].Missile.velocity );
	VecToAnglesBuggy( cl.h2_Effects[ index ].Missile.velocity, cl.h2_Effects[ index ].Missile.angle );
}
...
static void CLHW_TurnEffectStar( int index, float time, vec3_t position, vec3_t velocity ) {
	...
	effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Star.entity_index ];
	VectorCopy( position, ent->state.origin );
	VectorCopy( velocity, cl.h2_Effects[ index ].Star.velocity );
}
...
static void CLH2_LinkEffectEntity( effect_entity_t* entity ) {
	...
	CLH2_SetRefEntAxis( &refEntity, entity->state.angles, oldvec3_origin,
...
static void CLH2_UpdateEffectRain( int index, float frametime ) {
	...
	CLH2_RainEffect( cl.h2_Effects[ index ].Rain.min_org, cl.h2_Effects[ index ].Rain.e_size,
		cl.h2_Effects[ index ].Rain.dir[ 0 ], cl.h2_Effects[ index ].Rain.dir[ 1 ],
		cl.h2_Effects[ index ].Rain.color, cl.h2_Effects[ index ].Rain.count );
...
static void CLH2_UpdateEffectSnow( int index, float frametime ) {
	...
	if ( cl.h2_Effects[ index ].Snow.next_time < 0.10 ) {
		return;
	}
...
static float CLH2_UpdateEffectSmokeTimeAmount( int index ) {
	float smoketime = cl.h2_Effects[ index ].Smoke.framelength;
	if ( !smoketime ) {
...
static int CLH2_UpdateEffectSmokeCommon( int index, float frametime, float& smoketime ) {
	...
	if ( !CLH2_UpdateEffectSmokeEntity( index, cl.h2_Effects[ index ].Smoke.entity_index, frametime, smoketime, i ) ) {
		CLH2_FreeEffect( index );
	}
	return i;
}
...
static void CLHW_UpdateEffectTeleportSmoke1( int index, float frametime ) {
	...
	CLH2_UpdateEffectSmokeEntity( index, cl.h2_Effects[ index ].Smoke.entity_index2, frametime, smoketime, i );
}
...
static void CLH2_UpdateEffectExplosionCommon( int index, float frametime, float frameDuration ) {
	...
	while ( cl.h2_Effects[ index ].Smoke.time_amount >= frameDuration ) {
		ent->state.frame++;
		cl.h2_Effects[ index ].Smoke.time_amount -= frameDuration;
	}
...
static void CLH2_UpdateEffectGravityWell( int index, float frametime ) {
	...
	org[ 0 ] += sin( cl.h2_Effects[ index ].GravityWell.time_amount * idMath::TWO_PI ) * 30;
	org[ 1 ] += cos( cl.h2_Effects[ index ].GravityWell.time_amount * idMath::TWO_PI ) * 30;
...
static void CLH2_UpdateEffectTeleporterPuffs( int index, float frametime ) {
	...
	float smoketime = cl.h2_Effects[ index ].Teleporter.framelength;
		...
		if ( cl.h2_Effects[ index ].Xbow.activebolts & ( 1 << i ) ) {	//bolt in air, simply update position
			...
			if ( cl.h2_Effects[ index ].Xbow.state[ i ] == 0 ) {//waiting to explode state
				if ( cl.h2_Effects[ index ].Xbow.gonetime[ i ] > cl.serverTime * 0.001 ) {	//fiery bolts stick around for a while
					...
					cl.h2_Effects[ index ].Xbow.gonetime[ i ] = cl.serverTime * 0.001 + HX_FRAME_TIME * 2;
				...
				while ( cl.h2_Effects[ index ].Xbow.gonetime[ i ] <= cl.serverTime * 0.001 ) {
					ent->state.frame++;
...
static void CLHW_UpdateEffectDeathBubbles( int index, float frametime ) {
	...
	if ( cl.h2_Effects[ index ].Bubble.time_amount > 0.1 ) {//10 bubbles a sec
		...
		h2entity_state_t* es = CLH2_FindState( cl.h2_Effects[ index ].Bubble.owner );
		if ( es ) {
			vec3_t org;
...
static void CLHW_UpdateEffectScarabChain( int index, float frametime ) {
	...
	CLH2_CreateStreamChain( cl.h2_Effects[ index ].Chain.ent1, cl.h2_Effects[ index ].Chain.tag,
		1, 0, 100, cl.h2_Effects[ index ].Chain.origin, ent->state.origin );
}
...
static void CLHW_UpdateEffectTripMineStill( int index, float frametime ) {
	...
	CLH2_CreateStreamChain( cl.h2_Effects[ index ].Chain.ent1, 1, 1, 0, 100,
		cl.h2_Effects[ index ].Chain.origin, ent->state.origin );
}
...
static void CLHW_UpdateEffectMissileStar( int index, float frametime ) {
	...
	effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Star.entity_index ];
	if ( cl.h2_Effects[ index ].Star.ent2 != -1 ) {
		effect_entity_t* ent2 = &EffectEntities[ cl.h2_Effects[ index ].Star.ent2 ];
		VectorCopy( ent->state.origin, ent2->state.origin );
		ent2->state.scale = cl.h2_Effects[ index ].Star.scale;
		ent2->state.angles[ 1 ] += frametime * -300;
		ent2->state.angles[ 2 ] += frametime * -400;
...
static void CLH2_UpdateEffectChunk( int index, float frametime ) {
	...
	for ( int i = 0; i < cl.h2_Effects[ index ].Chunk.numChunks; i++ ) {
		effect_entity_t* ent = &EffectEntities[ cl.h2_Effects[ index ].Chunk.entity_index[ i ] ];
...
static void CLH2_UpdateEffectRiderDeath( int index, float frametime ) {
	...
	org[ 0 ] += sin( cl.h2_Effects[ index ].RD.time_amount * idMath::TWO_PI ) * 30;
	org[ 1 ] += cos( cl.h2_Effects[ index ].RD.time_amount * idMath::TWO_PI ) * 30;
