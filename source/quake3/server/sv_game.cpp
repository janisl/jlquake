...
qintptr SV_GameSystemCalls(qintptr* args)
{
	...
	case BOTLIB_AI_NEXT_CONSOLE_MESSAGE:
		return botlib_export->ai.BotNextConsoleMessage(args[1], (bot_consolemessage_q3_t*)VMA(2));
	...
	case BOTLIB_AI_CHOOSE_NBG_ITEM:
		return botlib_export->ai.BotChooseNBGItem(args[1], (float*)VMA(2), (int*)VMA(3), args[4], (bot_goal_q3_t*)VMA(5), VMF(6));
	case BOTLIB_AI_TOUCHING_GOAL:
		return botlib_export->ai.BotTouchingGoal((float*)VMA(1), (bot_goal_q3_t*)VMA(2));
	...
	case BOTLIB_AI_MOVEMENT_VIEW_TARGET:
		return botlib_export->ai.BotMovementViewTarget(args[1], (bot_goal_q3_t*)VMA(2), args[3], VMF(4), (float*)VMA(5));
