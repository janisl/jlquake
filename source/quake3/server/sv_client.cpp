...
gotnewcl:
	...
	*newcl = temp;
	...
	qintptr denied = VM_Call(gvm, Q3GAME_CLIENT_CONNECT, clientNum, qtrue, qfalse);	// firstTime = qtrue
	if (denied)
	{
...
void SV_ClientEnterWorld(client_t* client, q3usercmd_t* cmd)
{
	...
	VM_Call(gvm, Q3GAME_CLIENT_BEGIN, client - svs.clients);
}
...
static void SV_UpdateUserinfo_f(client_t* cl)
{
	...
	VM_Call(gvm, Q3GAME_CLIENT_USERINFO_CHANGED, cl - svs.clients);
}
