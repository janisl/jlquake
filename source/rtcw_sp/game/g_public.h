...
// recent id changes
#define SVF_SINGLECLIENT        0x00000800	// only send to a single client (wsentityShared_t->singleClient)
...
typedef enum {
	...
	G_GET_USERCMD,	// ( int clientNum, wsusercmd_t *cmd )
...
// done.
	...
	BOTLIB_USER_COMMAND,			// ( int client, wsusercmd_t *ucmd );
