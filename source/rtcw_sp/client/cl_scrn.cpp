...
void SCR_DrawScreenField(stereoFrame_t stereoFrame)
{
	...
	if (!VM_Call(uivm, WSUI_IS_FULLSCREEN))
	{
		switch (cls.state)
		{
		default:
		...
		case CA_CONNECTED:
			...
			VM_Call(uivm, WSUI_REFRESH, cls.realtime);
			VM_Call(uivm, WSUI_DRAW_CONNECT_SCREEN, false);
			break;
...
//			}
		...
		case CA_PRIMED:
			...
			VM_Call(uivm, WSUI_REFRESH, cls.realtime);
			VM_Call(uivm, WSUI_DRAW_CONNECT_SCREEN, true);
			break;
		case CA_ACTIVE:
			CL_CGameRendering(stereoFrame);
			SCR_DrawDemoRecording();
