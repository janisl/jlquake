...
static void *Mod_LoadAllSkins (int numskins, dmdl_skintype_t *pskintype, int mdl_flags)
{
	...
	for (i=0 ; i<numskins ; i++)
	{
		...
		pheader->gl_texture[i][0] = R_CreateImage(name, pic32, pheader->skinwidth, pheader->skinheight, true, true, GL_REPEAT, false);
		delete[] pic32;
...
=================
*/
static void * Mod_LoadSpriteFrame (model_t *mod, void * pin, msprite1frame_t **ppframe, int framenum)
{
...
=================
*/
static void * Mod_LoadSpriteGroup (model_t *mod, void * pin, msprite1frame_t **ppframe, int framenum)
{
